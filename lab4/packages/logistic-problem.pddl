...
(define (problem C3_2)
  ...
  (:init
   ...
   (huge packet1) (huge packet2)
   (medium packet3) (medium packet4)
   (small packet5) (small packet6) (small packet7)
   ...
   (dronebase dronebase1) (dronebase dronebase2)
  ...
  (:goal (and (at packet1 office2) (at packet2 office2) (at packet3 office2) (at packet4 office2) (at packet5 office2) (at packet6 office2) (at packet7 office2)))
  )
