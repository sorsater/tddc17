...
(define (domain logistics)
  ...
  (:action betterload
    :parameters (?o ?v ?l)
    :precondition (and (or((huge ?o) (medium ?o) (small ?o))) (or((airplane ?v) (truck ?v))) (location ?l)
		       (at ?v ?l) (at ?o ?l))
    :effect (and (in ?o ?v) (not (at ?v ?l))))
  ...
  (:action smallload
    :parameters (?o ?v ?l)
    :precondition (and (small ?o) (drone ?v) (location ?l)
		       (at ?v ?l) (at ?o ?l))
  ...
  (:action dronefly
    :parameters (?d ?b1 ?b2)
    :precondition (and (drone ?d) (dronebase ?b1) (dronebase ?b1) (at ?d ?b1))
    :effect (and (at ?d ?b2) (not (at ?d ?b1))))
