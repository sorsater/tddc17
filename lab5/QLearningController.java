...
public class QLearningController extends Controller {
	...
	final static int ACTION_000 = 0;
	final static int ACTION_001 = 1;
	final static int ACTION_010 = 2;
	final static int ACTION_011 = 3;
	final static int ACTION_100 = 4;
	final static int ACTION_101 = 5;
	final static int ACTION_110 = 6;
	final static int ACTION_111 = 7;
		...
		if (!paused) {
			...
			if (previous_state != null) {
				...
				if (print_counter % 10 == 0) {
					System.out.println("ITERATION: " + iteration + " R: " + df.format(previous_reward) + " SENSORS: a=" + df.format(angle.getValue()) + " vx=" + df.format(vx.getValue()) + 
