public class StateAndReward {
	...
	/*
		* the main idea for the hover function is:
		* give reward for angle/vy in two steps. (ignore vx)
		* first, "raw" reward which quickly direct the rocket in a close to hover state
		* second, give "fine tuning" reward in a small area to train the rocket to perform well
		* To trim the rocket, there exist three really good states which have a high reward.
		* In those three steps all parameters needs to be really small
	*/
